...
# name_data = 'small_B_data_S_core_top5_R' + str(target_field_id) + '.csv'
...
# name_shuffle = 'small_B_shuffle_id_S_core_top5_R' + str(target_field_id) + '.csv'
name_data = 'small_B_data_E_core_top5_R' + str(target_field_id) + '.csv'
name_trainset = 'small_B_train_E_core_top5_R' + str(target_field_id) + '.csv'
name_testset = 'small_B_test_E_core_top5_R' + str(target_field_id) + '.csv'
name_shuffle = 'small_B_shuffle_id_E_core_top5_R' + str(target_field_id) + '.csv'
