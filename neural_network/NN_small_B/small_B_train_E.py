...
for i in range(epochs):
    ...
    for step, data in enumerate(train_bar):
        ...
        loss = criterion_2(outputs.float(), train_Y2.float())
        loss.backward()
        optimizer.step()
