...
name_refer = 'small_B_E_core_top5_R' + str(target_field_id) + '_1.pth'
...
train_df = small_B_selfdataset.SelfDataset_E_core(path_trainset, target_field_id)
...
# **********模型训练设置**********
# 模型
model = small_B_model.NN_E_core(target_field_id)
# 设备
