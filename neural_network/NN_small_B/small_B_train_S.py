...
name_pth = 'small_B_S_R' + str(target_field_id) + '_12.pth'
name_trainset = 'small_B_train_S_R' + str(target_field_id) + '.csv'
name_testset = 'small_B_test_S_R' + str(target_field_id) + '.csv'
name_refer = 'small_B_S_R' + str(target_field_id) + '_12.pth'
...
for i in range(epochs):
    ...
    for step, data in enumerate(train_bar):
        ...
        loss = criterion_2(outputs.float(), train_Y1.float())
        loss.backward()
        optimizer.step()
