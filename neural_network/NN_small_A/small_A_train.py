...
name_trainset = 'small_A_train.csv'
name_testset = 'small_A_test.csv'
name_refer = 'small_A_1.pth'
...
train_df = small_A_selfdataset.SelfDataset(path_trainset)
...
for i in range(epochs):
    ...
    for step, data in enumerate(train_bar):
        ...
        loss = criterion_1(outputs, train_Y)
        loss.backward()
        optimizer.step()
    ...
    with torch.no_grad():
        ...
        for step, data in enumerate(test_bar):
            ...
            test_loss = criterion_2(outputs, test_Y)
