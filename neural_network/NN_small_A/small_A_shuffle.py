...
name_data = 'small_A_data.csv'
name_trainset = 'small_A_data_train.csv'
name_testset = 'small_A_data_test.csv'
name_shuffle = 'small_A_shuffle_id.csv'

# 样本个数
path_data = path_save + name_data
data_NN = pd.read_csv(path_data, header=0, encoding='utf-8').to_numpy()
...
df_train = pd.DataFrame(data_train,
                        columns=["job_id", "C1", "C2", "C3", "C4", "C5", "C6", "Fx", "Fy", "Fz", "Mx", "My", "Mz"])
df_train.to_csv(path_trainset, encoding='utf-8', index=False, header=True)
...
df_test = pd.DataFrame(data_test,
                       columns=["job_id", "C1", "C2", "C3", "C4", "C5", "C6", "Fx", "Fy", "Fz", "Mx", "My", "Mz"])
df_test.to_csv(path_testset, encoding='utf-8', index=False, header=True)
