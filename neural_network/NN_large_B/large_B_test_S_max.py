...
name_pth = 'large_B_SR' + str(target_field_id) + '_1.pth'
name_testset = 'large_B_data_test_S_R' + str(target_field_id) + '.csv'
...
loaded_model = large_B_model.NN_S(target_field_id)
