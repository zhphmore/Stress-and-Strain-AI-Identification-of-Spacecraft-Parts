...
name_pth = 'large_B_E_core_top5_R' + str(target_field_id) + '_1.pth'
name_testset = 'large_B_test_E_core_top5_R' + str(target_field_id) + '.csv'
...
test_df = large_B_selfdataset.SelfDataset_E_core(path_testset, target_field_id)
...
loaded_model = large_B_model.NN_E_core(target_field_id)
