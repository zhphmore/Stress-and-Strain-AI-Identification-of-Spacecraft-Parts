...
name_refer = 'large_B_S_core_top5_R' + str(target_field_id) + '_1.pth'
...
train_df = large_B_selfdataset.SelfDataset_S_core(path_trainset, target_field_id)
...
# **********模型训练设置**********
# 模型
model = large_B_model.NN_S_core(target_field_id)
# 设备
