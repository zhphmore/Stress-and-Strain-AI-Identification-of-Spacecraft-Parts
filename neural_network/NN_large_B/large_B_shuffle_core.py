...
name_data = 'large_B_data_S_core_top5_R' + str(target_field_id) + '.csv'
name_trainset = 'large_B_train_S_core_top5_R' + str(target_field_id) + '.csv'
name_testset = 'large_B_test_S_core_top5_R' + str(target_field_id) + '.csv'
name_shuffle = 'large_B_shuffle_id_S_core_top5_R' + str(target_field_id) + '.csv'
# name_data = 'large_B_data_E_core_top5_R' + str(target_field_id) + '.csv'
# name_trainset = 'large_B_train_E_core_top5_R' + str(target_field_id) + '.csv'
# name_testset = 'large_B_test_E_core_top5_R' + str(target_field_id) + '.csv'
# name_shuffle = 'large_B_shuffle_id_E_core_top5_R' + str(target_field_id) + '.csv'
