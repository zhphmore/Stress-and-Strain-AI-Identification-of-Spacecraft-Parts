...
# 为简易起见，本程序只处理小型零件
# 本程序只制作应力的数据集（应变是另一个程序EB_small_B_E.py）
...
# ④ 本程序实际需要运行多少次？
# 刚刚说了，神经网络B的应力预测部分包括4个子网络，需要4个数据集，因此本程序至少运行4次
...
# 听不懂吗？我这样讲吧：
# 第1次运行，产生small_B_S_R1_1.csv是n1×1023的
# 第2次运行，产生small_B_S_R1_2.csv是n2×1023的
# 第3次运行，产生small_B_S_R1_3.csv是n3×1023的
# 三次结果拼接，产生small_B_S_R1.csv是62234×1023的（n1+n2+n3=62234）
...
# 对于小型零件，危险区域1的应力的数据集：
# 理论上：
# small_B_S_R1.csv是62234×1023的
# 62234是样本数，1023列依次是：样本编号、6个载荷、mises应力×1016个网格单元（危险区域1的）
# 实际上：
# small_B_E_R1.csv是n×1023的
