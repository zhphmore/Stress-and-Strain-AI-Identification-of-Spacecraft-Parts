...
# ④ 本程序实际需要运行多少次？
# 刚刚说了，神经网络B的应变预测部分包括8个子网络，需要8个数据集，因此本程序至少运行8次
...
# 听不懂吗？我这样讲吧：
# 第1次运行，产生large_B_E_R1_1.csv是n1×4417的
# 第2次运行，产生large_B_E_R1_2.csv是n2×4417的
# 第3次运行，产生large_B_E_R1_3.csv是n3×4417的
# 三次结果拼接，产生large_B_E_R1.csv是67285×4417的（n1+n2+n3=67285）
...
# 对于大型零件，危险区域1的应变的数据集：
# 理论上：
# large_B_E_R1.csv是67285×4417的
# 67285是样本数，4417列依次是：样本编号、6个载荷、6个应变分量×735个网格单元（危险区域1的）
# 实际上：
# large_B_E_R1.csv是n×4417的
