...
# 关于程序FB输出的这1个csv的说明：
# 举例：
# large_B_sort_top5_R1.csv，格式是125×3
# 说明大型零件危险区域1有125个核心单元
...
# 假设1号学校共选出了125名核心学生参加竞赛
# 那么输出的csv就是125行3列的，列依次是各核心学生的单元编号、区域顺序编号、出现次数
# 这125行按出现次数从大到小排序
...
num_region_row = [0, 735, 1192, 1645, 2350, 3080, 3535, 3990]
